<?php
  ...
  $database = new CreateDb("shopping", "products");
...
<body>
    ...
    <h1 class="shoptitle">13$ RECORD STORE</h1>
    <div class="container">
        <div class="row text-center py-5">
            <?php
                ...
                {
                    component($row['product_name'], $row['product_artist'], $row['product_image'], $row['product_id']);
                }
            ?>
        </div>
    </div>
