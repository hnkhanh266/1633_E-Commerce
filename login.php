...
<body>
    ...
    <section class="hero-img">
      <div class="login-page">
          <h2>Log In</h2>
          <form action="login.php" method="post" class="login"> <br>
              <input type="email" name="email" id="" placeholder="Email" value="<?php echo $email; ?>" required> <br> <br>
              <input type="password" name="password" id="" placeholder="Password" required> <br><br>
              <button type="submit" name="submit_log">Log In</button> <br> <br>
